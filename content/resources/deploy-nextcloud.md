...
<!-- These changes for the **Test Train version** of Nextcloud app until the app moves to the official train it goes to. The current Stable app has completely different Install wizard screens and instructions!! -->
