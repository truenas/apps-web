...
{{< trueimage src="/images/Apps/DiscoverScreenChiaApp.png" alt="Locating the Chia App Widget" id="Locating the Chia App Widget" >}}

Click on the widget to open the **Chia** app information screen.

{{< trueimage src="/images/Apps/ChiaAppDetailsScreen.png" alt="Chia App Information Screen" id="Chia App Information Screen" >}}

Click **Install** to open the **Install Chia** configuration screen.

{{< trueimage src="/images/Apps/InstallChiaScreen.png" alt="Install Chia Screen" id="Install Chia Screen" >}}
...
{{< trueimage src="/images/Apps/InstallChiaConfigFullNodeService.png" alt="Install Chia Configuration" id="Install Chia Configuration" >}}
...
{{< trueimage src="/images/Apps/InstallChiaStorageConfigixVolume.png" alt="Install Chia Storage ixVolume" id="Install Chia Storage ixVolume" >}}
...
{{< trueimage src="/images/Apps/ChiaAppInstalled.png" alt="Chia App Installed" id="Chia App Installed" >}}
...
{{< trueimage src="/images/Apps/ChiaAppWorkloadsWidget.png" alt="Chia Workloads Widget" id="Chia Workloads Widget" >}}

Click on the shell <span class="iconify" data-icon="ci:window-terminal"></span> icon to open the **Choose pod** window.

{{< trueimage src="/images/Apps/ChiaChoosPodforShell.png" alt="Chia Choose Pod for Shell" id="Chia Choose Pod for Shell" >}}
...
{{< trueimage src="/images/Apps/ChiaShellShowMnemonicSeed.png" alt="Chia Mnemonic-Seed Command Example" id="Chia Mnemonic-Seed Command Example" >}}
...
{{< trueimage src="/images/Apps/EditChiaConfigAddEnvironmentVariable.png" alt="Edit Chia Add Keys Environment Variable" id="Edit Chia Add Keys Environment Variable" >}}
...
{{< trueimage src="/images/Apps/ChiaGUISetupInstallOptions.png" alt="Chia Setup Wizard Install Options" id="Chia Setup Wizard Install Options" >}}

Click **Next**. Choose the installation location.

{{< trueimage src="/images/Apps/ChiaSetupGUIChooseLocation.png" alt="Chia Setup Wizard Install Location" id="Chia Setup Wizard Install Location" >}}
...
{{< trueimage src="/images/Apps/ChiaWebPortalGUI.png" alt="Chia Web Portal" id="Chia Web Portal" >}}
...
{{< trueimage src="/images/Apps/InstallChiaConfigHarvesterService.png" alt="Install Chia Harvester Service" id="Install Chia Harvester Service" >}}
...
{{< trueimage src="/images/Apps/InstallChiaNetworkConfig.png" alt="Chia Network Configuration" id="Chia Network Configuration" >}}
...
{{< trueimage src="/images/Apps/InstallChiaStorageConfigHostPaths.png" alt="Install Chia Storage Host Paths" id="Install Chia Storage Host Paths" >}}
...
{{< trueimage src="/images/Apps/InstallChiaStorageConfigAdditionalVolsHostPath.png" alt="Install Chia Storage Additional Volumes" id="Install Chia Storage Additional Volumes" >}}
...
{{< trueimage src="/images/Apps/InstallChiaResourcesConfig.png" alt="Resources Configuration" id="Resources Configuration" >}}
