...
If you are unsure about any configuration settings, review the [Custom App Screens](https://www.truenas.com/docs/scale/25.10/scaleuireference/apps/installcustomappscreens/) UI reference article before creating a new container image.
...
If yes, [create the dataset(s)](https://www.truenas.com/docs/scale/25.10/scaletutorials/datasets/datasetsscale/) before you begin the app installation.
